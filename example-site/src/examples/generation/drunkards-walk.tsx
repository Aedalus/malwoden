...
const DrunkardsWalk = () => {
  useEffect(() => {
<<<<<<< HEAD:example-site/src/examples/generation/drunkards-walk.tsx
    const mount = document.getElementById("example")!;
=======
    const mount = document.getElementById("example");
>>>>>>> 89d998a6a685a92fc85cd4b9c38d6767791bc786:example-site/examples/generation/drunkards-walk.tsx
